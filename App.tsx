   ...
   return (
      <div className="min-h-screen bg-black text-white font-sans flex flex-col lg:flex-row overflow-hidden relative">
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in duration-300 p-4">
               <div className="bg-zinc-950 border-2 border-orange-600 p-10 rounded-[3rem] shadow-[0_0_100px_rgba(234,88,12,0.4)] max-w-lg w-full text-center space-y-8 relative">
                  ...
                  <div className="space-y-4">
                     <button onClick={handleKeySelection} className="w-full bg-gradient-to-r from-orange-600 to-amber-600 py-5 rounded-2xl font-black uppercase tracking-widest hover:scale-[1.02] transition-transform shadow-xl">
                        Selecionar Chave API
                     </button>
                     <button onClick={() => setShowApiKeyModal(false)} className="text-xs font-bold text-zinc-600 uppercase hover:text-white transition-colors">
                        Cancelar e Voltar
                     </button>
                  </div>
         ...
         <header className="lg:hidden flex items-center justify-between p-6 border-b border-zinc-800 bg-zinc-950 z-40 relative sticky top-0">
            ...
            <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="p-2 text-zinc-400 hover:text-white rounded-lg active:bg-zinc-800 transition-colors">
      ...
      `}>
               ...
               <div key="dashboard" className="max-w-7xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out pb-20">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                     {[
                        ...
                        <div key={card.id} onClick={() => setActiveModule(card.id)} className="group relative bg-zinc-950 border border-zinc-900 rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-12 h-[320px] md:h-[420px] flex flex-col justify-end overflow-hidden cursor-pointer transition-all hover:border-purple-600 shadow-2xl">
                  ...
                  <div className="space-y-8 md:space-y-10">
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        <div className="space-y-2">
                           <label className="flex items-center gap-2 text-[10px] font-black text-zinc-500 uppercase tracking-widest"><User size={12} className="text-purple-500" /> Nome de Exibição</label>
                           <input className="w-full bg-zinc-950 border border-zinc-800 focus:border-purple-600 rounded-2xl px-5 py-4 text-sm font-bold text-white transition-all outline-none shadow-inner" type="text" value={profile.displayName} onChange={e => setProfile({ ...profile, displayName: e.target.value })} aria-label="Nome de Exibição" />
                        </div>
                        <div className="space-y-2">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                        <div className="space-y-2">
                           ...
                           <input className="w-full bg-zinc-950 border border-zinc-800 focus:border-pink-600 rounded-2xl px-5 py-4 text-sm font-bold text-white transition-all outline-none shadow-inner" type="text" value={profile.instagram} onChange={e => setProfile({ ...profile, instagram: e.target.value })} aria-label="Instagram" title="Instagram" />
                        </div>
                        <div className="space-y-2">
                           ...
                           <input className="w-full bg-zinc-950 border border-zinc-800 focus:border-blue-600 rounded-2xl px-5 py-4 text-sm font-bold text-white transition-all outline-none shadow-inner" type="number" value={profile.clients} onChange={e => setProfile({ ...profile, clients: e.target.value })} aria-label="Clientes" title="Clientes" />
                        </div>
                        <div className="space-y-2">
                           ...
                           <input className="w-full bg-zinc-950 border border-zinc-800 focus:border-orange-600 rounded-2xl px-5 py-4 text-sm font-bold text-white transition-all outline-none shadow-inner" type="number" value={profile.team} onChange={e => setProfile({ ...profile, team: e.target.value })} aria-label="Time/Equipe" title="Time/Equipe" />
                        </div>
                     </div>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        <div className="space-y-2">
                           ...
                           <select value={profile.gender} onChange={e => setProfile({ ...profile, gender: e.target.value })} className="w-full bg-zinc-950 border border-zinc-800 focus:border-purple-600 rounded-2xl px-5 py-4 text-sm font-bold text-white transition-all outline-none appearance-none" aria-label="Gênero" title="Gênero">
                     ...
                     <div className="space-y-2 max-w-sm">
                        ...
                        <input className="w-full bg-zinc-950 border border-zinc-800 focus:border-green-600 rounded-2xl px-5 py-4 text-sm font-bold text-white transition-all outline-none shadow-inner" type="text" value={profile.whatsapp} onChange={e => setProfile({ ...profile, whatsapp: e.target.value })} aria-label="Whatsapp" title="Whatsapp" />
                     </div>
                  ...
                  <div className="flex-1 relative min-h-auto md:min-h-[750px] bg-zinc-950/60 rounded-[3rem] md:rounded-[4.5rem] border-2 border-zinc-900 overflow-hidden p-6 md:p-16 flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12">
                     <div className="space-y-8 w-full lg:w-80 relative z-10 order-2 lg:order-1">
                        ...
                        <div className="bg-zinc-900/80 border-2 border-purple-600/30 rounded-3xl p-6 shadow-2xl space-y-5">
                           ...
                           <div onClick={() => vortexMediaInput.current?.click()} className="aspect-square border-2 border-dashed border-zinc-800 rounded-2xl flex items-center justify-center bg-black/40 hover:border-purple-600 transition-all cursor-pointer overflow-hidden">{vortexNodes.media ? <img src={vortexNodes.media} className="w-full h-full object-cover" alt="Midia" title="Midia" /> : <Plus className="text-zinc-800" />}</div>
               ...
               <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 animate-in fade-in">
                  <div className="lg:col-span-4 space-y-8">
                     <div className="bg-zinc-950 p-10 rounded-[3rem] border border-zinc-900 shadow-2xl space-y-6">
                        ...
                        <div onClick={() => editorRefInput.current?.click()} className="aspect-video border-2 border-dashed border-zinc-800 rounded-3xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden">{editorBaseImage ? <img src={editorBaseImage} className="w-full h-full object-cover" alt="Imagem Base" title="Imagem Base" /> : <Plus className="text-pink-600" size={32} />}</div>
               ...
               <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
                  <div className="lg:col-span-4 space-y-8">
                     <div className="bg-zinc-950 p-10 rounded-[3rem] border border-zinc-900 shadow-2xl space-y-6">
                        ...
                        <div onClick={() => fileInputRef.current?.click()} className="aspect-video border-2 border-dashed border-zinc-800 rounded-3xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden">{refFile ? <img src={refFile} className="w-full h-full object-cover" alt="Referência" title="Referência" /> : <Plus className="text-purple-600" size={32} />}</div>
                        ...
                        <div className="space-y-6 pt-4 border-t border-zinc-900">
                           ...
                           <div className="space-y-1"><label className="text-[9px] font-black text-zinc-600 uppercase tracking-widest px-2">Cenário</label><select value={labScenario} onChange={e => setLabScenario(e.target.value)} className="w-full bg-zinc-950 border border-zinc-800 p-4 rounded-xl text-xs font-bold text-white" aria-label="Cenario" title="Cenario">{scenarios.map(s => <option key={s}>{s}</option>)}</select></div>
                           ...
                           <textarea value={extraDetails} onChange={e => setExtraDetails(e.target.value)} placeholder="Detalhes neurais..." className="w-full p-5 bg-zinc-950 border border-zinc-800 rounded-[2rem] text-xs h-32 resize-none text-white outline-none" aria-label="Detalhes Extras" title="Detalhes Extras" />
                  ...
                  <div className="lg:col-span-4 space-y-8">
                     <div className="bg-zinc-950 p-8 rounded-[3rem] border border-zinc-900 shadow-2xl">
                        ...
                        <div className="space-y-6 mt-8 pt-4 border-t border-zinc-900">
                           ...
                           <div className="space-y-1"><label className="text-[9px] font-black text-zinc-600 uppercase tracking-widest px-2">Ângulo da Foto</label><select value={carAngle} onChange={e => setCarAngle(e.target.value)} className="w-full bg-zinc-950 border border-zinc-800 p-4 rounded-xl text-xs font-bold text-white" aria-label="Angulo Carro" title="Angulo Carro">{(['Frontal baixo', 'Perfil', 'Traseira 3/4', 'Drone']).map(a => <option key={a}>{a}</option>)}</select></div>
               ...
               <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 animate-in fade-in">
                  <div className="lg:col-span-4 space-y-8">
                     <div className="bg-zinc-950 p-10 rounded-[3rem] border border-zinc-900 shadow-2xl space-y-6">
                        ...
                        <div onClick={() => fileInputRef.current?.click()} className="aspect-square border-2 border-dashed border-zinc-800 rounded-3xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden">{refFile ? <img src={refFile} className="w-full h-full object-cover" alt="Referencia Business" title="Referencia Business" /> : <Plus className="text-blue-600" size={32} />}</div>
                        ...
                        <div className="space-y-4">
                           <select value={bizLight} onChange={e => setBizLight(e.target.value)} className="w-full bg-zinc-900 border border-zinc-800 p-4 rounded-xl text-xs font-bold text-white" aria-label="Iluminacao" title="Iluminacao">{bizLights.map(l => <option key={l}>{l}</option>)}</select>
                           <input value={bizOutfit} onChange={e => setBizOutfit(e.target.value)} placeholder="Outfit (Ex: Navy Suit)" className="w-full bg-zinc-900 border border-zinc-800 p-4 rounded-xl text-xs font-bold text-white" aria-label="Roupa Business" title="Roupa Business" />
                        </div>
                        ...
                        <div className="space-y-4">
                           <div className="space-y-2">
                              ...
                              <div onClick={() => remixMapRef.current?.click()} className="h-32 border-2 border-dashed border-zinc-800 rounded-2xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden hover:border-purple-500 transition-colors">
                                 {remixMap ? <img src={remixMap} className="w-full h-full object-cover" alt="Layout Map" title="Layout Map" /> : <Plus className="text-zinc-600" size={24} />}
                              </div>
                              <input type="file" hidden ref={remixMapRef} onChange={e => handleFile(e, setRemixMap)} aria-label="Upload Layout Map" title="Upload Layout Map" />
                           </div>
                           <div className="space-y-2">
                              ...
                              <div onClick={() => remixSoulRef.current?.click()} className="h-32 border-2 border-dashed border-zinc-800 rounded-2xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden hover:border-purple-500 transition-colors">
                                 {remixSoul ? <img src={remixSoul} className="w-full h-full object-cover" alt="Soul Style" title="Soul Style" /> : <Plus className="text-zinc-600" size={24} />}
                              </div>
                              <input type="file" hidden ref={remixSoulRef} onChange={e => handleFile(e, setRemixSoul)} aria-label="Upload Soul Style" title="Upload Soul Style" />
                           </div>
                        </div>
               ...
               <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 animate-in fade-in">
                  <div className="lg:col-span-4 space-y-8">
                     <div className="bg-zinc-950 p-10 rounded-[3rem] border border-zinc-900 shadow-2xl space-y-6">
                        ...
                        <div onClick={() => mockupInputRef.current?.click()} className="aspect-square border-2 border-dashed border-zinc-800 rounded-3xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden">{mockupProduct ? <img src={mockupProduct} className="w-full h-full object-cover" alt="Produto Mockup" title="Produto Mockup" /> : <Plus className="text-green-600" size={32} />}</div>
                        ...
                        <div className="space-y-4">
                           <input value={mockupEnv} onChange={e => setMockupEnv(e.target.value)} placeholder="Ambiente (Ex: Mesa de Madeira)" className="w-full bg-zinc-900 border border-zinc-800 p-4 rounded-xl text-xs font-bold text-white" aria-label="Ambiente" title="Ambiente" />
                           <input value={mockupComp} onChange={e => setMockupComp(e.target.value)} placeholder="Composição (Ex: Minimalista)" className="w-full bg-zinc-900 border border-zinc-800 p-4 rounded-xl text-xs font-bold text-white" aria-label="Composicao" title="Composicao" />
                        </div>
                  ...
                  <div className="lg:col-span-4 space-y-8">
                     <div className="bg-zinc-950 p-10 rounded-[3rem] border border-zinc-900 shadow-2xl space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                           ...
                           <div onClick={() => ugcModelRef.current?.click()} className="aspect-square border-2 border-dashed border-zinc-800 rounded-2xl flex items-center justify-center bg-zinc-900/30 cursor-pointer">{ugcModel ? <img src={ugcModel} className="w-full h-full object-cover rounded-xl" alt="Modelo UGC" title="Modelo UGC" /> : <div className="text-center"><User size={20} className="mx-auto" /><span className="text-[8px] font-bold">MODELO</span></div>}</div>
                        </div>
                        ...
                        <textarea value={ugcContext} onChange={e => setUgcContext(e.target.value)} placeholder="Contexto (Ex: Selfie no espelho da academia)" className="w-full h-32 bg-black border border-zinc-800 p-4 rounded-2xl text-xs text-white resize-none" aria-label="Contexto UGC" title="Contexto UGC" />
               ...
               <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 animate-in fade-in">
                  <div className="lg:col-span-4 space-y-8">
                     <div className="bg-zinc-950 p-10 rounded-[3rem] border border-zinc-900 shadow-2xl space-y-6">
                        ...
                        <div onClick={() => fileInputRef.current?.click()} className="aspect-video border-2 border-dashed border-zinc-800 rounded-3xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden">{refFile ? <img src={refFile} className="w-full h-full object-cover" alt="Referencia" title="Referencia" /> : <Plus className="text-purple-600" size={32} />}</div>
                        ...
                        <div className="space-y-4">
                           <select value={restoreMode} onChange={e => setRestoreMode(e.target.value)} className="w-full bg-zinc-900 border border-zinc-800 p-4 rounded-xl text-xs font-bold text-white" aria-label="Modo Restauracao" title="Modo Restauracao">{restoreModes.map(m => <option key={m.id} value={m.id}>{m.title}</option>)}</select>
                           <select value={damageLevel} onChange={e => setDamageLevel(e.target.value)} className="w-full bg-zinc-900 border border-zinc-800 p-4 rounded-xl text-xs font-bold text-white" aria-label="Nivel de Dano" title="Nivel de Dano"><option>Leve</option><option>Médio</option><option>Grave</option></select>
                        </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                     <div className="bg-zinc-950 p-10 rounded-[3rem] border border-zinc-900 shadow-2xl space-y-6">
                        <div className="grid grid-cols-2 gap-4">
                           ...
                           <div onClick={() => consultFeedRef.current?.click()} className="aspect-square border-2 border-dashed border-zinc-800 rounded-2xl flex flex-col items-center justify-center cursor-pointer hover:border-blue-500">{consultFeed ? <img src={consultFeed} className="w-full h-full object-cover rounded-xl" alt="Consultoria Feed" title="Consultoria Feed" /> : <span className="text-xs font-bold text-zinc-500">FEED</span>}</div>
                        </div>
                        ...
                        <input value={consultNiche} onChange={e => setConsultNiche(e.target.value)} placeholder="Nicho (Ex: Design, Fitness)" className="w-full bg-zinc-900 border border-zinc-800 p-4 rounded-xl text-xs font-bold text-white" aria-label="Nicho Consultoria" title="Nicho Consultoria" />
         ...
         <div className="fixed bottom-4 lg:bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-6 lg:gap-12 bg-zinc-950/90 backdrop-blur-3xl px-8 lg:px-14 py-4 lg:py-6 rounded-full border border-zinc-800 shadow-[0_30px_80px_rgba(0,0,0,0.9)] z-50 pointer-events-auto border-white/5 max-w-[90vw] lg:max-w-none justify-center">
            <div className="flex items-center gap-3 lg:gap-5 group cursor-pointer" onClick={() => setActiveModule('settings')}>
