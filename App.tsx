                  ...
                  <div className="space-y-8 md:space-y-10">
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        <div className="space-y-2">
                           ...
                           <input className="w-full bg-zinc-950 border border-zinc-800 focus:border-purple-600 rounded-2xl px-5 py-4 text-sm font-bold text-white transition-all outline-none shadow-inner" type="text" value={profile.displayName} onChange={e => setProfile({ ...profile, displayName: e.target.value })} aria-label="Nome de Exibição" title="Nome de Exibição" />
                        </div>
                        <div className="space-y-2">
               ...
               <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 animate-in fade-in">
                  <div className="lg:col-span-4 space-y-8">
                     <div className="bg-zinc-950 p-10 rounded-[3rem] border border-zinc-900 shadow-2xl space-y-6">
                        ...
                        <div onClick={() => editorRefInput.current?.click()} className="aspect-video border-2 border-dashed border-zinc-800 rounded-3xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden" title="Upload Imagem Base">{editorBaseImage ? <img src={editorBaseImage} className="w-full h-full object-cover" alt="Imagem Base" title="Imagem Base" /> : <Plus className="text-pink-600" size={32} />}</div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                     ...
                     <div className="lg:col-span-4 space-y-6">
                        ...
                        <div className="bg-zinc-950 border border-zinc-900 rounded-[2.5rem] p-8 shadow-2xl">
                           ...
                           <div onClick={() => asset3dRefInput.current?.click()} className="aspect-video border-2 border-dashed border-zinc-800 hover:border-red-500 rounded-2xl flex flex-col items-center justify-center bg-black/40 cursor-pointer transition-all group overflow-hidden" title="Upload Referência Asset">
               ...
               <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
                  <div className="lg:col-span-4 space-y-8">
                     <div className="bg-zinc-950 p-10 rounded-[3rem] border border-zinc-900 shadow-2xl space-y-6">
                        ...
                        <div onClick={() => fileInputRef.current?.click()} className="aspect-video border-2 border-dashed border-zinc-800 rounded-3xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden" title="Upload Referência">{refFile ? <img src={refFile} className="w-full h-full object-cover" alt="Referência" title="Referência" /> : <Plus className="text-purple-600" size={32} />}</div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 min-h-[700px]">
                     ...
                     <div className="lg:col-span-4 bg-zinc-950 border border-zinc-900 rounded-[2.5rem] p-8 shadow-2xl space-y-6 overflow-y-auto custom-scrollbar max-h-[800px]">
                        ...
                        <div className="space-y-2">
                           ...
                           <div onClick={() => fileInputRef.current?.click()} className="aspect-video border-2 border-dashed border-zinc-800 hover:border-zinc-600 rounded-3xl flex flex-col items-center justify-center bg-black/40 cursor-pointer transition-all group overflow-hidden relative" title="Upload Referência Hero">
                     ...
                     <div className="bg-zinc-950 p-10 rounded-[3rem] border border-zinc-900 shadow-2xl space-y-6">
                        ...
                        <div className="space-y-4">
                           <div className="space-y-2">
                              ...
                              <div onClick={() => remixMapRef.current?.click()} className="h-32 border-2 border-dashed border-zinc-800 rounded-2xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden hover:border-purple-500 transition-colors" title="Upload Layout Map">
                           ...
                           <div className="space-y-2">
                              ...
                              <div onClick={() => remixSoulRef.current?.click()} className="h-32 border-2 border-dashed border-zinc-800 rounded-2xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden hover:border-purple-500 transition-colors" title="Upload Soul Style">
               ...
               <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 animate-in fade-in">
                  <div className="lg:col-span-4 space-y-8">
                     <div className="bg-zinc-950 p-10 rounded-[3rem] border border-zinc-900 shadow-2xl space-y-6">
                        ...
                        <div onClick={() => fileInputRef.current?.click()} className="aspect-video border-2 border-dashed border-zinc-800 rounded-3xl flex items-center justify-center bg-zinc-900/30 cursor-pointer overflow-hidden" title="Upload Referência para Restaurar">{refFile ? <img src={refFile} className="w-full h-full object-cover" alt="Referencia" title="Referencia" /> : <Plus className="text-purple-600" size={32} />}</div>
